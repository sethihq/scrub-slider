  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--page)] transition-[background-color] duration-300">
      ...
      <a
        ...
        className="fixed bottom-4 right-5 inline-flex items-center gap-1.5 text-[11px] tracking-wide text-[var(--page-text-muted)] transition-colors duration-200 hover:text-[var(--page-text)]"
      >
